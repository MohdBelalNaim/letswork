...
const Edit = ({ controller }) => {
  const field = [
    ...
    { title: "Skills (Comma separated)", name: "skills" },
    { title: "Bio", name: "bio" },
  ];
  ...
  async function handleUpdate(data) {
    ...
    setLoading(true);
    const result = await updateUserProfile(data, user);
  ...
  return (
    <div className="inset-0 bg-black/30 backdrop-blur-md fixed z-[9999999] grid place-items-center overflow-scroll max-sm:py-4">
