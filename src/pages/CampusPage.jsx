        ...
        <main>
          <div className="bg-white p-4 rounded border-gray-300 border max-sm:p-2">
            ...
            <div className="text-sm w-[60%] mx-auto text-center max-sm:w-[100%] max-sm:text-xs">
              ...
              Perspiciatis obcaecati aspernatur rerum assumenda maxime culpa
              nulla tenetur iusto tempora incidunt commodi iste quia voluptates
              enim, hic eos eaque. Sapiente, reiciendis! enim, hic eos eaque.
              Sapiente, reiciendis! Lorem ipsum dolor, sit amet consectetur
              adipisicing elit.
            </div>
